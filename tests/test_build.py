from terrarium import Serializer, SampleGraphBuilder, ProtocolBlueprintBuilder, ProtocolGraphBuilder
...
def test_build(session):
    ...
    blueprint = ProtocolBlueprintBuilder().build(all_nodes=all_afts, nodes=nodes, edges=edges)
